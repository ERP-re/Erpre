...
import '../../../resources/static/css/hr/EmployeeAttend.css'; // 개별 CSS 스타일 적용

// 컴포넌트
function EmployeeAttend() {
    return (
        <Layout currentMenu="employeeAttend"> {/* 레이아웃 컴포넌트, currentMenu는 현재 선택된 메뉴를 나타냄 */}
